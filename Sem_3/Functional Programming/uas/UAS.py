...
# Fungsi untuk menampilkan data kesehatan sesuai id yang dicari (Read)
...
# Fungsi untuk membuat form tambah data kesehatan
def form_tambah() : 
  return [{
...
# Fungsi untuk membuat form edit data kesehatan
def form_edit() :
  return {
          'nama_pasien': input("Masukkan nama pasien: "), 
          'detak_jantung': int(input("Masukkan detak jantung (bpm): ")), 
