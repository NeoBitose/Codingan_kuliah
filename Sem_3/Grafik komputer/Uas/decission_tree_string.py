...
data = pd.read_csv('data.csv')  # Gantilah 'nama_file.csv' dengan nama file CSV Anda
...
X = data.drop('ProductPurchased', axis=1)  # Gantilah 'ProductPurchased' dengan nama kolom label Anda
y = data['ProductPurchased']
